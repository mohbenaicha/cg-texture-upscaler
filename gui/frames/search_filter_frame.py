...
class SearchFilterFrame(ctk.CTkFrame):
    ...
    def setup_frame_elements(self):
        ...
        self.filter_curr_list_button = ctk.CTkButton(
            ...
            command=lambda: self.apply_filter(None, "current_list"),
        )
        ...
        self.filter_selected_dir_button = ctk.CTkButton(
            ...
            font=fonts.buttons_font(),
            command=lambda: self.apply_filter(None, "chosen_dir"),
        )
    ...
    def apply_filter(self, bind_value, source_list: str):
        # TODO: assign bond value

        and_filters: List[str] = [
            filter_txt.get() for filter_txt in self.and_filters_str
        ]
        or_filters: List[str] = [filter_txt.get() for filter_txt in self.or_filters_str]
        ...
        if any(bad_chars_found):
            ...
            self.lb_frame.filter(and_filters, or_filters, source_list)
