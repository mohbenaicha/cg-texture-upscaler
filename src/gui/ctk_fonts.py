...
def smaller_options_font():
    return ctk.CTkFont(family="Gill Sans MT", size=GUIConfig.smaller_option_fontsize)


def buttons_font():
    return ctk.CTkFont(family="Gill Sans MT", size=GUIConfig.button_fontsize)

def small_buttons_font():
    return ctk.CTkFont(family="Gill Sans MT", size=GUIConfig.small_button_fontsize)
