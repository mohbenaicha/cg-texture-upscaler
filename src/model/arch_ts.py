...
class DenseBlock(nn.Module):
    ...
    def __init__(self, in_channels=64, channels_per_conv=32, res_scale=0.2):
        ...
        self.conv_list: List[nn.Module] = nn.ModuleList([
            self.conv_block_1,
            self.conv_block_2,
            self.conv_block_3,
            self.conv_block_4,
...
class Basic_Block(nn.Module):
    ...
    def __init__(self, in_channels=64, channels_per_conv=32, res_scale=0.2):
        ...
        self.dense_blocks: List[nn.Module] = nn.ModuleList([self.dense_block_1, self.dense_block_2, self.dense_block_3])
...
class Generator(nn.Module):
    ...
    def __init__(
        ...
        self.unshuffle = nn.PixelUnshuffle(downscale_factor=2) if self.scale == 2 else None
    ...
    def forward(self, x):
        ...
        """
        if self.scale == 2 and self.unshuffle is not None:
            x = self.unshuffle(x)
